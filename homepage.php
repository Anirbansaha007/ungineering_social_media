...
<html>
    ...
    <body>
        <div class="a">
            ...
            <div class="ac2">
                <div class="newc">
                    <a class="lb" href="registration.html">
                        <div class="new">
                            New user
                        </div>
                    </a>
        ...
        <div class="b">
            <div class="br">
                <div class="b1"><h4>Name</h4>
                </div>
                <div class="b2">
                    asdfgh asdfgh asdfgh asdfga asdfg asdfg asdfg asdf sdfg asdfgwsedfg sdfgsdf sdfg sdfg xcvbn werftg asdfgb wertg ertg sdfgxcv sdfg adsfgd asdfgds waesrtyredsxzc hgfdkl sdfghfxfdsewq scdxfvgtrfesdxcv sadfvgtrewdsfxvcfr aefsrdgtdfdxvfgbt gtfe4 trtg yugy jhg yggyg hgwqewrfgtftrefgbf wdfgdsasfvcf dwdefdds gytf fytfytfyf.
                </div>
                <div class="b3">Time:24.40 Hrs IST | 1 jan
                </div>
            </div>
            <div class="br">
                <div class="b1"><h4>Name</h4>
